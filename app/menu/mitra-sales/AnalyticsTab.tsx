...
const sections: Sprint14g1Section[] = [
  {
    ...
    title: "Performa dan Kualitas Mitra Sales",
    description:
      "Melihat pertumbuhan mitra, komposisi jenis mitra, kontribusi referral, kualitas conversion, dan intensitas hubungan Sales dengan mitra.",
    diagrams: [
...
export default function MitraSalesAnalyticsTab() {
  return (
    <Sprint14g1Board
