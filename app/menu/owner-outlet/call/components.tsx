...
export default function CallPage({
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    if (!canSave) {
      showError({
        ...
        solution: "Isi Status Call atau Status Chat, pilih Remarks, dan tulis Kesimpulan sebelum menyimpan.",
      });
      return;
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-black/25 p-3">
      <div className="app-modal-panel flex h-[88vh] w-full max-w-4xl rounded-[22px] bg-white p-3 shadow-sm">
        <div className="app-modal-header mb-2 flex shrink-0 items-center justify-between gap-3 rounded-[18px] px-4 py-3">
          ...
          <button
            type="button"
            onClick={handleClose}
            className="app-modal-close inline-flex items-center gap-2 rounded-xl px-4 py-2 text-xs font-black shadow-sm transition hover:border-[#C92C1E]/30 hover:text-[#C92C1E]"
          >
